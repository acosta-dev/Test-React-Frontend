        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          ...
          <div className="hidden lg:block">
            <div className="flex items-center">
              <button className="inline-block text-sm px-4 py-2 bg-[#2D509E] rounded-full leading-none border-white hover:border-transparent hover:scale-110 mt-4 lg:mt-0 text-white font-bold text-[20px] shadow-xl shadow-[#709DDA] border-0">
                {t("contact")}
              </button>
              <LocaleSwitcher />
            </div>
